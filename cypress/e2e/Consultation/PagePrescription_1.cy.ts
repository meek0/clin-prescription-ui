...
describe('Page d\'une prescription - Vérifier les informations affichées', () => {
  it('Panneau Analyse', () => {
    ...
    cy.get('[data-cy="AnalysisCard"] [class="ant-descriptions-item-content"]').eq(5).contains(epCHUSJ_ldmCHUSJ.stampDate.substring(0, 7)).should('exist');
    cy.get('[data-cy="AnalysisCard"] [class="ant-descriptions-item-content"]').eq(6).contains(/(--|ALLARD René)/).should('exist');
  ...
  it('Panneau Information clinique', () => {
    ...
    cy.get('[data-cy="ClinicalInformation_CollapsePanel"] [data-row-key="0"] [class="ant-table-cell"]').eq(3).contains(epCHUSJ_ldmCHUSJ.stampDate.substring(0, 7)).should('exist');
  ...
  it('Panneau Mère', () => {
    ...
    cy.get('[data-cy="ParentCard_Mère_CollapsePanel"] [data-row-key="0"] [class="ant-table-cell"]').eq(3).contains(epCHUSJ_ldmCHUSJ.stampDate.substring(0, 7)).should('exist');
  ...
  it('Panneau Père', () => {
    ...
    cy.get('[data-cy="ParentCard_Père_CollapsePanel"] [data-row-key="0"] [class="ant-table-cell"]').eq(3).contains(epCHUSJ_ldmCHUSJ.stampDate.substring(0, 7)).should('exist');
