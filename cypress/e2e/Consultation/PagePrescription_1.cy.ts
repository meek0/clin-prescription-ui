...
describe('Page d\'une prescription - Vérifier les informations affichées', () => {
  it('Panneau Analyse', () => {
    ...
    cy.get('[data-cy="AnalysisCard"] [class="ant-descriptions-item-content"]').eq(1).contains('Routine').should('exist');
  ...
  it('Panneau Information clinique', () => {
    ...
    cy.get('[data-cy="ClinicalInformation_CollapsePanel"] [data-row-key="0"] [class="ant-table-cell"]').eq(1).contains("75020 - Séquençage de l'exome normal").should('exist');
  ...
  it('Panneau Mère', () => {
    ...
    cy.get('[data-cy="ParentCard_Mère_CollapsePanel"] [data-row-key="0"] [class="ant-table-cell"]').eq(1).contains("75020 - Séquençage de l'exome normal").should('exist');
  ...
  it('Panneau Père', () => {
    ...
    cy.get('[data-cy="ParentCard_Père_CollapsePanel"] [data-row-key="0"] [class="ant-table-cell"]').eq(1).contains("75020 - Séquençage de l'exome normal").should('exist');
